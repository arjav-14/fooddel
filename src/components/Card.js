...
//   const { imgSrc, foodName, price } = props; // Pass price directly
...
//       payload: {
//         foodName: foodName,
//         totalPrice: price, // Assuming price is the total price for one item
...
//           <div>
//             <button className="bg-success text-white" style={{ fontSize: "16px" }} onClick={addToCart}>
//               Add to Cart
//             </button>
//           </div>
//         </div>
